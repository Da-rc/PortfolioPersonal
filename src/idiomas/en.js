export default {
    ...
    aboutComp: {
        texto: 'Hello <s>world!</s> I am a Full Stack developer who loves to create useful and creative solutions. ' +
            ...
            'My journey into software development behan in 2021, when I discovered the world of programming.' +
    ...
    proyectos: [
        {id: 1, titulo: 'Portfolio', texto: "Personal portfolio developed with Vue.js and JavaScript, focused on providing a clean and functional design. Utilizes Vue Router for organizing views" +
                " and components, enhancing scalability. This project serves as an interactice window into my development projects, including direct links to their respective GitHub repositories and webs",
        ...
        {id: 3, titulo: 'Higher technicion final project', texto: "My final project for my software development studies was the creation of a video game fro Android devices. " +
        ...
        {id: 4, titulo: 'Android Video Game', texto: "Personal project of a video game for Android devices. A classic platformer where the player must overcome" +
                ...
                " a leaderboard. The projects was developed in Unity using C#, with the implementation of Firebase Firestore Database, a document-based database, for managing user scores.",
